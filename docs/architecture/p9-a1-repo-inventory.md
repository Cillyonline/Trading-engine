...
- `docs/`: Project documentation, runbooks, and specifications (see `docs/getting-started/local-run.md`, `docs/operations/deterministic-analysis.md`, `docs/testing/smoke-run.md`).
...
- API server (FastAPI): `PYTHONPATH=src uvicorn api.main:app --reload` (documented in `docs/getting-started/local-run.md`).
- Deterministic analysis run (module):
  ...
  ```
  (documented in `docs/operations/deterministic-analysis.md`).
