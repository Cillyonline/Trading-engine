...
| docs/operations/api-cookbook.md | file | API usage cookbook. | keep |  |
| docs/testing/numeric-output-precision.md | file | Numeric output precision guidance. | keep |  |
| docs/operations/deterministic-analysis.md | file | Deterministic analysis documentation. | keep |  |
| docs/testing/smoke-run.md | file | Smoke run instructions. | keep |  |
| docs/getting-started/local-run.md | file | Local run guide. | keep |  |
...
| docs/architecture/reports/I-029a_implicit_time_inventory.md | file | Implicit time inventory report. | candidate-for-archive | Historical report. |
| docs/architecture/reports/repo_audit_DISC-4_C2.md | file | Repository audit report. | candidate-for-archive | Historical report. |
| docs/architecture/standards/ | dir | Standards and rules documents. | keep |  |
| docs/architecture/standards/breaking-change-regeln.md | file | Breaking change rules. | keep |  |
| docs/architecture/phase-6-exit-criteria.md | file | Phase 6 exit criteria. | keep |  |
| docs/testing/snapshot-testing.md | file | Snapshot testing guidance. | keep |  |
| docs/architecture/mvp-v1.md | file | MVP v1 specification. | keep |  |
| docs/operations/runbook.md | file | Operational runbook. | keep |  |
| docs/governance/ | dir | Governance and process documentation. | keep |  |
| docs/architecture/governance/stop-conditions-and-merge-authority.md | file | Stop conditions and merge authority. | keep |  |
| docs/architecture/governance/external-readiness-checklist.md | file | External readiness checklist. | keep |  |
| docs/architecture/governance/pr-review-checklist-test-gated.md | file | PR review checklist. | keep |  |
| docs/architecture/governance/phase-5-exit-criteria.md | file | Phase 5 exit criteria. | keep |  |
| docs/architecture/governance/explicit-test-gated-execution-mode.md | file | Explicit test-gated mode details. | keep |  |
| docs/architecture/governance/execution-modes.md | file | Execution modes description. | keep |  |
| docs/testing/ | dir | Testing guidance documents. | keep |  |
| docs/testing/determinism.md | file | Determinism testing guidance. | keep |  |
| docs/operations/analyst-workflow.md | file | Analyst workflow steps. | keep |  |
| docs/api/ | dir | API documentation. | keep |  |
| docs/operations/api/external_api_happy_path.md | file | External API happy path. | keep |  |
| docs/operations/api/usage_contract.md | file | API usage contract. | keep |  |
| docs/operations/api/api_guarantees.md | file | API guarantees definition. | keep |  |
| docs/architecture/mvp-spec.md | file | MVP specification. | keep |  |
| docs/index.md | file | Documentation index. | keep |  |
| docs/exploration/ | dir | Exploration notes. | keep |  |
| docs/operations/exploration/exploration-guide.md | file | Exploration guide. | keep |  |
| docs/testing/fixtures.md | file | Fixtures documentation. | keep |  |
| docs/phase-6/ | dir | Phase 6 documentation. | keep |  |
| docs/operations/phase-6/PHASE_6_OPERATIONAL_OVERVIEW.md | file | Phase 6 operational overview. | keep |  |
| docs/getting-started/repo-snapshot.md | file | Repo snapshot documentation. | keep |  |
| docs/checklists/ | dir | Project checklists. | keep |  |
| docs/testing/checklists/phase-6-exit-checklist.md | file | Phase 6 exit checklist. | keep |  |
| docs/architecture/strategy-configs.md | file | Strategy configuration documentation. | keep |  |
| docs/architecture/repo-hygiene-audit.md | file | Non-code repository hygiene audit. | keep | Current report. |
...
## Verification
No repository files were modified except docs/architecture/repo-hygiene-audit.md.
