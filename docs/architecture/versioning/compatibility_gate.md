...
This review is **mandatory** and MUST be completed before tagging any release, as defined in `docs/architecture/versioning/release_boundary.md`.
...
The classification MUST align with `docs/architecture/versioning/change_enforcement.md`.
