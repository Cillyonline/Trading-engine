...
- This project has one single authoritative version, as defined in `docs/architecture/versioning/model.md`.
...
### 2.4 Contracts
- Contracts inherit the project version, aligned with `docs/architecture/versioning/model.md`.
