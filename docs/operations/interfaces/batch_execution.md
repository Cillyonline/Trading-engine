...
- The authoritative command-line contract for batch invocation is defined by `docs/operations/interfaces/cli_contract.md`.
...
- Stable contract surface:
  ...
  - Exit status success/failure boundary defined in this document and `docs/operations/interfaces/cli_contract.md`.
