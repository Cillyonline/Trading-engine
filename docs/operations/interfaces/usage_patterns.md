...
- Definition of “public API” in this project context:
  - The HTTP API behavior documented in `docs/operations/api/usage_contract.md`.
  - The supported Python import boundary documented in `docs/operations/api/public_api_boundary.md` (`from api import app`).
...
- Behavioral guarantees:
  - Guaranteed and non-guaranteed API behavior is limited to what is explicitly documented in `docs/operations/api/api_guarantees.md` and `docs/operations/api/usage_contract.md`.
...
### 4.2 API Stability
- Considered stable:
  - Documented API contracts in `docs/operations/api/usage_contract.md`.
  - Public API boundary in `docs/operations/api/public_api_boundary.md`.
