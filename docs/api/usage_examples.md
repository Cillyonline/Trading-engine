...
- Authoritative operator analysis contract: `docs/api/usage_contract.md` section `Canonical Operator Analysis Contract`
...
This is the workflow governed by issue `#600`. The payload shape shown here is the same shape documented in `docs/api/usage_contract.md`.
