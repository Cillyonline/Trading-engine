...
- To start and verify the local API, continue to `docs/getting-started/local-run.md`.
- To run the repository test suite, continue to `docs/testing/index.md`.
- To run the deterministic smoke run, continue to `docs/testing/smoke-run.md`.
