...
STRATEGY_PARAMETER_SPECS: dict[str, tuple[ParameterSpec, ...]] = {
    "RSI2": (
        ...
        ParameterSpec(
            canonical_name="entry_zone_lower_factor",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=10.0,
        ...
        ParameterSpec(
            canonical_name="entry_zone_upper_factor",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=10.0,
    ...
    "TURTLE": (
        ...
        ParameterSpec(
            canonical_name="stop_loss_buffer_pct",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=1.0,
        ...
        ParameterSpec(
            canonical_name="confirmed_score_min",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=100.0,
        ...
        ParameterSpec(
            canonical_name="confirmed_score_range",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=100.0,
        ...
        ParameterSpec(
            canonical_name="confirmed_max_breakout_strength_pct",
            aliases=(),
            type_=float,
            min_value=0.000001,
            max_value=1.0,
        ...
        ParameterSpec(
            canonical_name="confirmed_entry_zone_upper_factor",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=10.0,
        ...
        ParameterSpec(
            canonical_name="setup_score_base",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=100.0,
        ...
        ParameterSpec(
            canonical_name="setup_score_range",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=100.0,
        ...
        ParameterSpec(
            canonical_name="setup_entry_zone_upper_factor",
            aliases=(),
            type_=float,
            min_value=0.0,
            max_value=10.0,
